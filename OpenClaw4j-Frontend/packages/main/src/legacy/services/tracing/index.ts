...
export async function getTraces(params: TracingAPI.GetTracesParams) {
  return request<TracingAPI.GetTracesResult>(
    `${DIRECT_API_PATH}/observability/traces`,
    {
      method: 'GET',
      params,
    },
...
export async function getTraceDetail(params: { traceId: string }) {
  return request<TracingAPI.GetTraceDetailResult>(
    `${API_PATH}/observability/traces/${params.traceId}`,
    {
      method: 'GET',
    },
  );
...
export async function getServices(params: {
  ...
  return request<TracingAPI.GetServicesResult>(
    `${DIRECT_API_PATH}/observability/services`,
    {
      method: 'GET',
      params,
    },
...
export async function getOverview(params: TracingAPI.GetOverviewParams) {
  return request<TracingAPI.GetOverviewResult>(
    `${DIRECT_API_PATH}/observability/overview`,
    {
      method: 'GET',
      params,
    },
