...
export async function getPrompts(params: PromptAPI.GetPromptsParams) {
  return request<PromptAPI.GetPromptsResult>(`${DIRECT_API_PATH}/prompts`, {
    method: 'GET',
    params,
  });
}
...
export async function getPromptVersions(
  params: PromptAPI.GetPromptVersionsParams,
) {
  return request<PromptAPI.GetPromptVersionsResult>(
    `${API_PATH}/prompt/versions`,
    {
      method: 'GET',
      params,
    },
...
export async function getPromptVersion(
  params: PromptAPI.GetPromptVersionParams,
) {
  return request<PromptAPI.GetPromptVersionResult>(
    `${API_PATH}/prompt/version`,
    {
      method: 'GET',
      params,
    },
...
export async function publishPromptVersion(
  params: PromptAPI.PublishPromptVersionParams,
) {
  return request<PromptAPI.PublishPromptVersionResult>(
    `${API_PATH}/prompt/version`,
    {
      method: 'POST',
      data: params,
...
export async function getPromptSession(sessionId: string) {
  return request<PromptAPI.GetPromptSessionResult>(
    `${API_PATH}/prompt/session`,
    {
      method: 'GET',
      params: {
        sessionId,
...
export async function deletePromptSession(sessionId: string) {
  return request<PromptAPI.DeletePromptSessionResult>(
    `${API_PATH}/prompt/session`,
    {
      method: 'DELETE',
      params: {
...
export async function getPromptTemplates(
  params: PromptAPI.GetPromptTemplatesParams,
) {
  return request<PromptAPI.GetPromptTemplatesResult>(
    `${API_PATH}/prompt/templates`,
    {
      method: 'GET',
      params,
    },
...
export async function getPromptTemplate(params: { promptTemplateKey: string }) {
  return request<PromptAPI.GetPromptTemplateResult>(
    `${API_PATH}/prompt/template`,
    {
      method: 'GET',
      params,
    },
...
export async function getModels(params?: PromptAPI.GetModelsParams) {
  ...
  try {
    ...
    console.error(
      'Failed to get enabled models from ModelService, falling back to legacy API:',
      error,
    );
  }
