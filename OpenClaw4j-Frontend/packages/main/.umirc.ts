...
const withNoStoreProxy = (target: string) => ({
  target,
  changeOrigin: true,
  onProxyRes(proxyRes: { headers: Record<string, string> }) {
    Object.assign(proxyRes.headers, noStoreHeaders);
  },
});
...
export default defineConfig({
  ...
  define: {
    ...
    'process.env.LEGACY_API_DIRECT': process.env.LEGACY_API_DIRECT,
    ...
    },
    {
      ...
      routes: [
        { path: '/admin', component: '@/legacy/pages/index' },
        {
          ...
          component: '@/legacy/pages/playground/playground',
        },
        { path: '/admin/prompts', component: '@/legacy/pages/prompts/prompts' },
        {
          path: '/admin/prompt-detail',
          component: '@/legacy/pages/prompts/prompt-detail/prompt-detail',
        },
        {
          path: '/admin/version-history',
          component: '@/legacy/pages/prompts/version-history/version-history',
        },
        { path: '/admin/tracing', component: '@/legacy/pages/tracing/tracing' },
        {
          path: '/admin/evaluation/experiment',
          component: '@/legacy/pages/evaluation/experiment/index',
        },
        {
          path: '/admin/evaluation/experiment/create',
          component: '@/legacy/pages/evaluation/experiment/experimentCreate',
        },
        {
          path: '/admin/evaluation/experiment/detail/:id',
          component: '@/legacy/pages/evaluation/experiment/experimentDetail',
        },
        {
          path: '/admin/evaluation/gather',
          component: '@/legacy/pages/evaluation/gather/index',
        },
        {
          path: '/admin/evaluation/gather/create',
          component: '@/legacy/pages/evaluation/gather/gatherCreate',
        },
        {
          path: '/admin/evaluation/gather/detail/:id',
          component: '@/legacy/pages/evaluation/gather/gatherDetail',
        },
        {
          path: '/admin/evaluation/evaluator',
          component: '@/legacy/pages/evaluation/evaluator/index',
        },
        {
          path: '/admin/evaluation/evaluator/:id',
          component: '@/legacy/pages/evaluation/evaluator/evaluator-detail',
        },
        {
          path: '/admin/evaluation/debug',
          component: '@/legacy/pages/evaluation/evaluator/evaluator-debug',
        },
      ],
    },
    {
