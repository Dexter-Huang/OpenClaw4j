...
package com.seaskyland.llm.workflow.core.rag.splitter;
...
/**
 * A text splitter that splits text based on a regular expression pattern. It supports overlapping
 * segments to maintain context between splits.
 *
 * @since 1.0.0.3
 */
public class RegexTextSplitter extends TextSplitter {
  ...
  /**
   * Splits the input text into segments based on the regex pattern. Each segment includes an
   * overlap with the previous segment to maintain context.
   *
