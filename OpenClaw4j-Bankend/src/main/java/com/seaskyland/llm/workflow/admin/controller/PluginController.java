...
public class PluginController {
  ...
  public Result<Void> updatePlugin(
      @PathVariable("pluginId") String pluginId, @RequestBody Plugin request) {
    RequestContext context = RequestContextHolder.getRequestContext();
    validatePlugin(request);
  ...
  public Result<String> createTool(
      @PathVariable("pluginId") String pluginId, @RequestBody Tool tool) {
    RequestContext context = RequestContextHolder.getRequestContext();
  ...
  public Result<Void> deleteTool(
      @PathVariable("pluginId") String pluginId, @PathVariable("toolId") String toolId) {
    RequestContext context = RequestContextHolder.getRequestContext();
  ...
  public Result<PagingList<Tool>> listTools(
      @PathVariable("pluginId") String pluginId, @ModelAttribute ToolQuery query) {
    RequestContext context = RequestContextHolder.getRequestContext();
  ...
  public Result<ToolExecutionResult> testTool(
      @PathVariable("pluginId") String pluginId,
      @PathVariable("toolId") String toolId,
  ...
  public Result<Void> publishTool(
      @PathVariable("pluginId") String pluginId, @PathVariable("toolId") String toolId) {
    RequestContext context = RequestContextHolder.getRequestContext();
  ...
  private void validateTool(Tool tool) {
    ...
    if (!SUPPORT_METHOD.contains(requestMethod)) {
      throw new BizException(
          ErrorCode.INVALID_PARAMS.toError("requestMethod", "method not supported"));
    }
    ...
    if ("post".equalsIgnoreCase(requestMethod)) {
      ...
      if (!MediaType.APPLICATION_JSON_VALUE.equalsIgnoreCase(contentType)
        ...
        throw new BizException(
            ErrorCode.INVALID_PARAMS.toError("contentType", "contentType not supported"));
      }
    }
  }
}
