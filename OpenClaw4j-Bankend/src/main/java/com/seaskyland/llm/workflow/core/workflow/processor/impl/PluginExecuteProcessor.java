...
/**
 * plugin node for executing plugins. It uses the ToolExecutionService to execute the plugin and
 * handles errors listing functionality.
 *
 * @author huangtao
 * @since 1.0.0.3
 */
...
public class PluginExecuteProcessor extends AbstractExecuteProcessor {
  ...
  public NodeResult innerExecute(
    ...
    try {
      ...
      log.info(
          "plugin execute cost: {}ms, requestId:{}",
  ...
  private Map<String, Object> convertToPluginInput(
