...
public class WorkspaceServiceImpl extends ServiceImpl<WorkspaceMapper, WorkspaceEntity>
    ...
    if (workspaceCount > MAX_WORKSPACE_PER_ACCOUNT) {
      throw new BizException(
          ErrorCode.INVALID_REQUEST.toError(
              "workspace can not be more than " + MAX_WORKSPACE_PER_ACCOUNT + "."));
    }
  ...
  public void updateWorkspace(Workspace workspace) {
    ...
    WorkspaceEntity workspaceEntity =
        getWorkspaceByName(context.getAccountId(), workspace.getName());
  ...
  public PagingList<Workspace> listWorkspaces(BaseQuery query) {
    ...
    queryWrapper
        .eq(WorkspaceEntity::getAccountId, context.getAccountId())
  ...
  public Workspace getDefaultWorkspace(String uid) {
    ...
    LambdaQueryWrapper<WorkspaceEntity> queryWrapper = new LambdaQueryWrapper<>();
    queryWrapper
        .eq(WorkspaceEntity::getAccountId, uid)
        .ne(WorkspaceEntity::getStatus, CommonStatus.DELETED.getValue())
