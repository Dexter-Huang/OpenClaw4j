...
import static com.seaskyland.llm.workflow.core.workflow.constants.WorkflowConstants.ARRAY_CODE;
...
public enum JudgeOperator {
  ...
  EQUALS(
      ...
      "equals",
      Sets.newHashSet(
          ParameterTypeEnum.STRING.getCode(),
          ParameterTypeEnum.NUMBER.getCode(),
  ...
  LESS_AND_EQUAL(
      "lessAndEqual", "less than or equal to", Sets.newHashSet(ParameterTypeEnum.NUMBER.getCode())),
  ...
  LENGTH_EQUALS(
      ...
      Arrays.stream(ParameterTypeEnum.values())
          ...
          .filter(
              code ->
                  code.startsWith(ARRAY_CODE) || code.equals(ParameterTypeEnum.STRING.getCode()))
  ...
  CONTAINS(
      ...
      Arrays.stream(ParameterTypeEnum.values())
          ...
          .filter(
              code ->
                  code.startsWith(ARRAY_CODE)
                      || code.equals(ParameterTypeEnum.STRING.getCode())
