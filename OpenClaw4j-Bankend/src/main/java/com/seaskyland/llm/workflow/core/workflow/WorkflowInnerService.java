...
public class WorkflowInnerService {
	...
	public WorkflowContext getContextCache(String workspaceId, String taskId) {
		WorkflowContext context = cacheManager.get(WORKFLOW_TASK_CONTEXT_PREFIX + workspaceId + "_" + taskId);
	...
	private boolean isNodeStatusOlder(String newStatus, String oldStatus) {
		...
		// 数字越小表示状态越早
		Map<String, Integer> statusPriority = Map.of(NodeStatusEnum.EXECUTING.getCode(), 1,
