...
public class CustomSimpleVectorStore extends AbstractObservationVectorStore {
    ...
    public List<Document> doSimilaritySearch(SearchRequest request) {
        ...
        return this.store.values()
                ...
                .map(content -> content
                        .toDocument(CustomSimpleVectorStore.EmbeddingMath.cosineSimilarity(userQueryEmbedding, content.getEmbedding())))
    ...
    public static final class CustomSimpleVectorStoreBuilder extends AbstractVectorStoreBuilder<CustomSimpleVectorStoreBuilder> {
