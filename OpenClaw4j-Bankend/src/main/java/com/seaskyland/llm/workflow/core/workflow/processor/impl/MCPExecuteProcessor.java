 ...
 *
 * <p>This processor is responsible for handling MCP node execution in the workflow. It manages the
 * interaction with MCP servers and tools, handling requests and responses.
 *
 * <p>Features: 1. MCP server tool execution 2. Parameter conversion and validation 3. Response
 * handling and error management 4. Integration with workflow context
 *
 * @author guning.lt
 * @version 1.0.0-M1
 */
...
public class MCPExecuteProcessor extends AbstractExecuteProcessor {
  ...
  /**
   * Execute the MCP node processing This method handles the MCP tool execution process, including:
   * 1. Request construction 2. Tool execution 3. Response handling 4. Error management
   *
  ...
  public NodeResult innerExecute(
    ...
    if (responseResult != null && responseResult.isSuccess()) {
      ...
      String errorMsg =
          "MCP Node execute fail, requestId:"
              + responseResult.getRequestId()
              + ", "
              + "errorMsg:"
   ...
   */
  private McpServerCallToolRequest constructMcpServerCallToolRequest(
   ...
   */
  public HashMap<String, Object> convertToolParams(
