...
/**
 * Utility class for JSON operations. Provides methods for JSON serialization and deserialization.
 *
 * @since 1.0.0.3
 */
public class JsonUtils {
  ...
  /**
   * Jackson ObjectMapper instance configured with common settings -- GETTER -- Returns the
