...
/**
 * Custom deserializer for chat message content. Handles different types of content: arrays, text,
 * and other JSON nodes.
 */
  ...
  public Object deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
    ...
    if (node.isArray()) {
      return JsonUtils.getObjectMapper()
          .convertValue(node, new TypeReference<List<MultimodalContent>>() {});
