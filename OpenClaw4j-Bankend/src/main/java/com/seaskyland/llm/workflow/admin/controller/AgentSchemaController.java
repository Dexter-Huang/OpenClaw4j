...
public class AgentSchemaController {
  ...
  @PostMapping
  public Result<AgentSchemaEntity> createAgentSchema(
  ...
  public Result<AgentSchemaEntity> updateAgentSchema(
      @PathVariable Long id, @RequestBody AgentSchemaEntity agentSchemaEntity) {
  ...
  public Result<List<AgentSchemaEntity>> getAgentSchemas() {
    ...
    List<AgentSchemaEntity> agentSchemas =
        agentSchemaService.getAgentSchemasByWorkspaceId(workspaceId);
  ...
  public Result<PagingList<AgentSchemaEntity>> getAgentSchemasByPage(
    ...
    PagingList<AgentSchemaEntity> result =
        agentSchemaService.getAgentSchemasByWorkspaceId(workspaceId, page);
  ...
  public Result<List<AgentSchemaEntity>> searchAgentSchemas(@RequestParam String name) {
    String workspaceId = "1"; // Use default workspace ID that matches database
    List<AgentSchemaEntity> agentSchemas =
        agentSchemaService.getAgentSchemasByName(name, workspaceId);
    return Result.success(agentSchemas);
  }
