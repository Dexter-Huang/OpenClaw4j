...
public class AdminCompatController {
  ...
  public Result<Map<String, Object>> promptVersion(
  ...
  public Result<Map<String, Object>> runPrompt(@RequestBody Map<String, Object> body) {
    String sessionId =
        String.valueOf(body.getOrDefault("sessionId", java.util.UUID.randomUUID().toString()));
    return Result.success(
        Map.of("sessionId", sessionId, "type", "message", "content", "", "messageCount", 0));
  }
  ...
  public Result<Map<String, Object>> updateDatasetVersion(@RequestBody Map<String, Object> body) {
    return Result.success(
        service.getById("dataset_version", Long.valueOf(String.valueOf(body.get("id")))));
  }
  ...
  public Result<Map<String, Object>> updateDataItem(@RequestBody Map<String, Object> body) {
    return Result.success(
        service.getById("dataset_item", Long.valueOf(String.valueOf(body.get("id")))));
  }
  ...
  public Result<Map<String, Object>> debugEvaluator() {
    return Result.success(
        Map.of("score", 0, "reason", "No evaluator engine is configured", "evaluationTime", ""));
  }
