...
import static com.seaskyland.llm.workflow.runtime.enums.ErrorCode.APP_COMPONENT_ALREADY_EXISI_ERROR;
import static com.seaskyland.llm.workflow.runtime.enums.ErrorCode.APP_COMPONENT_DELETE_ERROR;
import static com.seaskyland.llm.workflow.runtime.enums.ErrorCode.APP_COMPONENT_NOT_FOUND_ERROR;
import static com.seaskyland.llm.workflow.runtime.enums.ErrorCode.APP_COMPONENT_UPDATE_ERROR;
...
import com.seaskyland.llm.workflow.runtime.enums.AppComponentUpdateEnum;
...
/**
 * Service implementation for managing application components. Handles CRUD operations and component
...
public class AppComponentServiceImpl extends ServiceImpl<AppComponentMapper, AppComponentEntity>
  ...
  public PagingList<AppComponent> getAppComponentList(AppComponentQuery request) {
    ...
    return new PagingList<>(
        request.getCurrent(), request.getSize(), pageResult.getTotal(), appComponentDTOS);
  }
  ...
  public Result<String> createAppComponent(AppComponent component) {
    AppComponent appComponentByAppId =
        getAppComponentByAppId(component.getAppId(), AppComponentStatusEnum.Published.getCode());
   ...
   */
  private List<AppComponent> toAppComponentDTO(
      List<AppComponentEntity> applicationComponentEntities) {
