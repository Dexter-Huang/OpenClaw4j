...
/**
 * Enum representing different parameter types for API parameters. Each type defines validation
 * rules for its corresponding data type.
 *
 * @since 1.0.0.3
 */
@Getter
