...
package com.seaskyland.llm.workflow.admin.resolver;
...
/**
 * Resolver for handling API model attributes in method arguments. Converts request parameters to
...
public class ApiModelAttributeMethodArgumentResolver implements HandlerMethodArgumentResolver {
   ...
   * @return true if parameter has ApiModelAttribute annotation and is not a simple property
   */
  @Override
