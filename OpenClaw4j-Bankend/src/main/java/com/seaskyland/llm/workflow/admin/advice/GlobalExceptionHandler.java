...
package com.seaskyland.llm.workflow.admin.advice;

import static com.seaskyland.llm.workflow.core.utils.LogUtils.FAIL;

import com.seaskyland.llm.workflow.admin.utils.HttpStreamUtils;
...
@RestControllerAdvice(
    basePackages = {"com.seaskyland.llm.workflow", "com.seaskyland.llm.workflow.admin"})
public class GlobalExceptionHandler {

  /**
   * Handles all exceptions and converts them to appropriate error responses. Maps different
   * exception types to corresponding error codes and messages.
   *
  ...
  public void exceptionHandler(
    ...
    try {
      ...
      LogUtils.monitor(
          context, "ExceptionHandler", "handleError", start, FAIL, body, json, headers, ex);
  ...
  /**
   * Builds validation error message from MethodArgumentNotValidException. Concatenates field names
  ...
  /**
   * Builds validation error message from ConstraintViolationException. Concatenates property paths
   * and their error messages.
   *
