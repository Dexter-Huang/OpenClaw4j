 ...
 */
package com.seaskyland.llm.workflow.core.model.llm.impl;
...
public class OpenAIProvider implements ModelProvider {
  ...
  private static final List<ParameterRule> defaultLLMParameterRules =
      Lists.newArrayList(
          new ParameterRule()
              .setCode("temperature")
              .setName("temperature")
