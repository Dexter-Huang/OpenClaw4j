...
public class McpServerController {
   ...
   * @param needTools Flag indicating whether to include tool information in the response
  ...
  public Result<McpServerCallToolResponse> debugTools(
      @RequestBody McpServerCallToolRequest request) {
    RequestContext context = RequestContextHolder.getRequestContext();
    ...
    Result<McpServerCallToolResponse> mcpServerCallToolResponseResult =
        mcpServerService.callTool(request);
