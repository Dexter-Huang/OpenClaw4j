...
/**
 * Utility class for logging operations. Provides methods for different log levels and specialized
 * logging for monitoring, tracing, and statistics.
 *
 * @since 1.0.0.3
 */
public class LogUtils {
  ...
  private static final Logger monitorLogger = LoggerFactory.getLogger("monitor-log");

  // Logger for statistics logs
  private static final Logger staticsLogger = LoggerFactory.getLogger("statics-log");

  // Logger for trace logs
  private static final Logger traceLogger = LoggerFactory.getLogger("trace-log");
  ...
  public static void monitor(
      ...
      Object... objects) {
    String status =
        StringUtils.isNotBlank(errorCode) && !errorCode.equalsIgnoreCase(SUCCESS) ? FAIL : SUCCESS;
  ...
  public static void trace(
      ...
      Object... objects) {
    Long costTime =
        startTime == null || startTime == 0 ? 0 : System.currentTimeMillis() - startTime;
