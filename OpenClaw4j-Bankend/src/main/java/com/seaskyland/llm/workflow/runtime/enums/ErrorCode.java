...
import static com.seaskyland.llm.workflow.runtime.constants.ApiConstants.*;
...
public enum ErrorCode {
  ...
  FORBIDDEN(
      ...
      INVALID_REQUEST_ERROR,
      "Forbidden",
      "Access denied, please contact service support for permission."),
  ...
  INVALID_REFRESH_TOKEN(
      401, INVALID_REQUEST_ERROR, "InvalidRefreshToken", "Refresh token is invalid."),
  ...
  BUILD_TOOL_SCHEMA_ERROR(
      400, INVALID_REQUEST_ERROR, "BuildToolSchemaError", "Failed to build tool schema."),
  ...
  TOOL_PARAMS_MISSING(
      400, INVALID_REQUEST_ERROR, "ToolParameterMissing", "Tool parameter [%s] is required."),

  TOOL_PARAMS_INVALID(
      400, INVALID_REQUEST_ERROR, "ToolParameterInvalid", "Tool parameter [%s] is invalid, %s"),
  ...
  APP_TYPE_NOT_SUPPORT(
      400, INVALID_REQUEST_ERROR, "AppTypeNotSupport", "App type [%s] is not supported."),

  REQUEST_TIMEOUT(
      408, RESPONSE_ERROR, "RequestTimeOut", "Request timed out, please try again later."),
  ...
  AGENT_LOOP_EXCEEDED(
      500, RESPONSE_ERROR, "AgentLoopExceeded", "Agent loop has exceeded more than %s loops."),
  ...
  /** account error code */
  ACCOUNT_NAME_EXISTS(
      400, INVALID_REQUEST_ERROR, "AccountNameExists", "Account name already exists."),

  ACCOUNT_EMAIL_EXISTS(
      400, INVALID_REQUEST_ERROR, "AccountEmailExists", "Account email already exists."),

  ACCOUNT_NOT_FOUND(404, RESPONSE_ERROR, "AccountNotFound", "Account can not be found."),

  ACCOUNT_PASSWORD_NOT_MATCH(
      400, INVALID_REQUEST_ERROR, "AccountPasswordNotMatch", "Account password does not match."),
  ...
  DEFAULT_WORKSPACE_NOT_FOUND(
      404, RESPONSE_ERROR, "DefaultWorkspaceNotFound", "Default workspace can not be found."),

  /** workspace error code */
  WORKSPACE_NAME_EXISTS(
      400, INVALID_REQUEST_ERROR, "WorkspaceNameExists", "Workspace name already exists."),
  ...
  MEDIA_TYPE_NOT_SUPPORTED(
      400, INVALID_REQUEST_ERROR, "MediaTypeNotSupported", "Request media type is not supported."),

  REQUEST_METHOD_NOT_SUPPORTED(
      405, INVALID_REQUEST_ERROR, "RequestMethodNotSupported", "Request method is not supported."),

  /** knowledge base error code */
  KNOWLEDGE_BASE_NAME_EXISTS(
      400, INVALID_REQUEST_ERROR, "KnowledgeBaseNameExists", "Knowledge base name already exists."),

  KNOWLEDGE_BASE_NOT_FOUND(
      404, RESPONSE_ERROR, "KnowledgeBaseNotFound", "Knowledge base can not be found."),

  DOCUMENT_NOT_FOUND(404, RESPONSE_ERROR, "DocumentNotFound", "Document can not be found."),

  DOCUMENT_RETRIEVAL_ERROR(
      500, RESPONSE_ERROR, "DocumentRetrievalError", "Document retrieval error."),

  DOCUMENT_RETRIEVAL_TIMEOUT(
      408, RESPONSE_ERROR, "DocumentRetrievalTimeout", "Document retrieval timeout."),

  UPDATE_DOCUMENT_CHUNK_ERROR(
      500, RESPONSE_ERROR, "UpdateDocumentChunkError", "Update document chunk error."),

  /** workflow error code */
  WORKFLOW_EXECUTE_ERROR(
      500, RESPONSE_ERROR, "WorkflowExecuteError", "Workflow execute error, root cause is %s"),

  WORKFLOW_NODE_DEBUG_FAIL(
      500, RESPONSE_ERROR, "WorkflowNodeDebugError", "Workflow node debug error."),

  WORKFLOW_DEBUG_FAIL(500, RESPONSE_ERROR, "WorkflowDebugError", "Workflow debug error."),

  WORKFLOW_DEBUG_GET_PROCESS_FAIL(
      500, RESPONSE_ERROR, "WorkflowGetDebugProcessError", "Workflow get debug process error."),

  WORKFLOW_DEBUG_INIT_FAIL(
      500, RESPONSE_ERROR, "WorkflowDebugInitError", "Workflow init debug params error."),

  WORKFLOW_CONFIG_INVALID(
      400, INVALID_REQUEST_ERROR, "WorkflowConfigInvalid", "Workflow config is invalid, %s"),
  ...
  WORKFLOW_EXECUTION_TIMEOUT(
      503, RESPONSE_ERROR, "WorkflowExecuteTimeout", "Workflow task is timeout"),
  ...
  MCP_CONFIG_NOT_FOUND(
      404, RESPONSE_ERROR, "MCPServerConfigNotFound", "MCPServer config can not be found."),

  MCP_TYPE_NOT_SUPPORT(
      400,
      INVALID_REQUEST_ERROR,
      "MCPServerTypeNotSupport",
  ...
  APP_COMPONENT_LIST_ERROR(
      500, RESPONSE_ERROR, "ComponentListError", "Failed to obtain component list."),

  APP_COMPONENT_PUBLISH_ERROR(
      500, RESPONSE_ERROR, "CreateComponentError", "Failed to release application as component."),

  APP_COMPONENT_UPDATE_ERROR(
      500, RESPONSE_ERROR, "UpdateComponentError", "Failed to update component."),

  APP_COMPONENT_DETAIL_ERROR(
      500, RESPONSE_ERROR, "QueryComponentError", "Failed to query component detail."),

  APP_COMPONENT_DELETE_ERROR(
      500, RESPONSE_ERROR, "DeleteComponentError", "Failed to delete component."),

  APP_COMPONENT_REFER_ERROR(
      500, RESPONSE_ERROR, "ReferComponentError", "Failed to query reference of component."),

  APP_COMPONENT_QUERYCONFIG_ERROR(
      500, RESPONSE_ERROR, "QueryConfigError", "Failed to query config of component."),

  APP_COMPONENT_PUBLISHABLE_ERROR(
      500, RESPONSE_ERROR, "QueryApplicationError", "Failed to get information of component."),

  APP_COMPONENT_NOT_FOUND_ERROR(
      404, RESPONSE_ERROR, "ComponentNotFound", "Component can not be found."),

  APP_COMPONENT_SCHEMA_ERROR(
      500, RESPONSE_ERROR, "QuerySchemaError", "Failed to get schema of component."),

  APP_COMPONENT_ALREADY_EXISI_ERROR(
      500,
      RESPONSE_ERROR,
  ...
  public static ErrorCode of(String errorCode) {
    ...
    Optional<ErrorCode> any =
        Arrays.stream(values()).filter(error -> errorCode.equals(error.getCode())).findAny();
