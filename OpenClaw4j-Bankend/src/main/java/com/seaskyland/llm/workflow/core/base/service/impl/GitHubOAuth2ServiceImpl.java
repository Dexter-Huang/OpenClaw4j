...
import com.seaskyland.llm.workflow.core.base.service.Oauth2Service;
import com.seaskyland.llm.workflow.core.config.OAuth2Config;
import com.seaskyland.llm.workflow.runtime.domain.account.Oauth2Type;
...
public class GitHubOAuth2ServiceImpl implements Oauth2Service {
  ...
  public String getAuthorizationUrl() {
    return String.format(
        ...
        config.getGithub().getAuthorizeUrl(),
        config.getGithub().getClientId(),
        config.getGithub().getRedirectUri());
  }
  ...
  public String getAccessToken(String code) {
    ...
    if (body.get("error") != null) {
      throw new BizException(
          ErrorCode.OAUTH2_CALL_ERROR.toError(), String.valueOf(result.getResponse()));
    }
