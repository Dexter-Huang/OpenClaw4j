...
public class RocketMqProducer implements MqProducer {
    ...
    public RocketMqProducer(MqConfigProperties mqConfigProperties,
    ...
    public void sendAsync(MqMessage message, SendCallback callback) {
        ...
        try {
            sendReceipt = future.get(mqConfigProperties.getSendMessageTimeoutMs(),
    ...
    private Message buildMessage(MqMessage message) {
        MessageBuilder msg = this.provider.newMessageBuilder()
