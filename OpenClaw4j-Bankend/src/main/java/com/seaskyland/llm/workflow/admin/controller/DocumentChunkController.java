...
/**
 * Controller for managing document chunks in RAG system. Provides CRUD operations for document
 * chunks and supports batch operations.
 *
 * @since 1.0.0.3
 */
@RestController
...
public class DocumentChunkController {
  ...
  public Result<String> createDocumentChunk(
      @PathVariable("docId") String docId, @RequestBody DocumentChunk chunk) {
  ...
  public Result<Void> updateDocumentChunk(
      @PathVariable("docId") String docId,
      @PathVariable("chunkId") String chunkId,
      @RequestBody DocumentChunk chunk) {
    RequestContext context = RequestContextHolder.getRequestContext();
  ...
  public Result<Void> deleteDocumentChunk(
      @PathVariable("docId") String docId, @PathVariable("chunkId") String chunkId) {
    RequestContext context = RequestContextHolder.getRequestContext();
    ...
    documentService.deleteDocumentChunks(
        DeleteChunkRequest.builder().docId(docId).chunkIds(List.of(chunkId)).build());
    return Result.success(context.getRequestId(), null);
  }
  ...
  public Result<Void> deleteDocumentChunk(
      @PathVariable("docId") String docId, @RequestBody DeleteChunkRequest request) {
    RequestContext context = RequestContextHolder.getRequestContext();
  ...
  public Result<PagingList<DocumentChunk>> listDocumentChunks(
      @PathVariable("docId") String docId, @ModelAttribute BaseQuery query) {
    RequestContext context = RequestContextHolder.getRequestContext();
  ...
  public Result<List<DocumentChunk>> previewDocumentChunks(
      @PathVariable("docId") String docId, @RequestBody IndexDocumentRequest request) {
    RequestContext context = RequestContextHolder.getRequestContext();
  ...
  public Result<Void> updateDocumentChunk(
      @PathVariable("docId") String docId, @RequestBody UpdateChunkRequest request) {
    RequestContext context = RequestContextHolder.getRequestContext();
