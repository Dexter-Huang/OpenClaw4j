...
import com.seaskyland.llm.workflow.core.utils.common.DateUtils;
...
/**
 * File manager for handling file operations including saving, loading and media type detection.
 *
 * @since 1.0.0.3
 */
@Slf4j
...
public class FileManager {
  ...
  /**
   * Saves an uploaded file to the storage system. The file path is constructed using category,
   * account ID, workspace ID, date and a unique identifier.
   *
  ...
  /**
   * Determines the media type of a file from its URL by analyzing the file header. Supports common
   * formats including JPEG, PNG, GIF, PDF, XML, and JSON.
   *
