...
import com.seaskyland.llm.workflow.core.base.domain.HttpDeleteWithBody;
...
/**
 * HTTP client manager for handling HTTP requests. Provides methods for making HTTP requests with
 * different methods (GET, POST, PUT, DELETE, etc.) and supports various content types (JSON, form
 * data, etc.).
 *
 * @since 1.0.0.3
 */
...
public class HttpClientManager implements InitializingBean {
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    PoolingHttpClientConnectionManager orchestraClientConnectionManager =
        new PoolingHttpClientConnectionManager(socketFactoryRegistry);
  ...
  public RpcResult doGetWithRequestId(
      String requestId, String url, Map<String, Object> headers, Map<String, Object> parameters) {
    try {
      ...
      LogUtils.error(
          "HttpClient doGet error requestId={}, url={}, headers={}, parameters={}",
          requestId,
          url,
  ...
  public RpcResult doPostJson(
      String url, Map<String, Object> headers, Map<String, Object> parameters) {
  ...
  public RpcResult doPostJsonWithRequestId(
      String requestId, String url, Map<String, Object> headers, Map<String, Object> parameters) {
    try {
      ...
      LogUtils.error(
          "HttpClient doPostJson error requestId={}, url={}, headers={}, parameters={}",
          requestId,
          url,
          JsonUtils.toJson(headers),
          JsonUtils.toJson(parameters),
  ...
  public RpcResult doPutJsonWithRequestId(
    ...
    try {
      ...
      LogUtils.error(
          "HttpClient doPutJson error requestId={},url={},headers={},parameters={}",
          requestId,
          url,
          JsonUtils.toJson(headers),
          JsonUtils.toJson(parameters),
  ...
  public RpcResult doDeleteJsonWithRequestId(
    ...
    try {
      ...
      LogUtils.error(
          "HttpClient doDeleteJson error.url={},headers={},parameters={}",
          url,
          JsonUtils.toJson(headers),
          JsonUtils.toJson(parameters),
          e);
  ...
  public RpcResult doPostFormWithRequestId(
    ...
    try {
      ...
      LogUtils.error(
          "HttpClientManager",
          "doPostForm",
          "request error ,url={},headers={},parameters={}",
          url,
          JsonUtils.toJson(headers),
          JsonUtils.toJson(parameters),
          e);
  ...
  public HttpUriRequest buildGetRequest(
      String url, Map<String, Object> header, Map<String, Object> parameters) {
  ...
  public HttpUriRequest buildPostJsonRequest(
      String url, Map<String, Object> header, Map<String, Object> parameters) {
  ...
  public HttpUriRequest buildPutJsonRequest(
      String url, Map<String, Object> header, Map<String, Object> parameters) {
  ...
  public HttpUriRequest buildDeleteJsonRequest(
      String url, Map<String, Object> header, Map<String, Object> parameters) {
  ...
  public HttpUriRequest buildPostFormRequest(
      String url, Map<String, Object> header, Map<String, Object> parameters) {
    HttpPost request = new HttpPost(url);
  ...
  public RpcResult doApiNodeWithRequestId(
      Method method,
      String requestId,
      String url,
    ...
    try {
      HttpRequestBase request =
          buildApiNodeRequest(method, url, headers, parameters, body, form, timeoutConfig);
      CloseableHttpResponse response = workflowHttpClient.execute(request);
      RpcResult rpcResult = processResponse(response);
      LogUtils.info(
          "HttpClientManager", method.getValue(), url, headers, parameters, body, form, rpcResult);
      return rpcResult;
    } catch (Exception e) {
      LogUtils.error(
          "HttpClient "
  ...
  public HttpRequestBase buildApiNodeRequest(
      Method method,
      String url,
  ...
  private void setEntityByType(
      HttpEntityEnclosingRequestBase request, String type, Map<String, Object> form) {
