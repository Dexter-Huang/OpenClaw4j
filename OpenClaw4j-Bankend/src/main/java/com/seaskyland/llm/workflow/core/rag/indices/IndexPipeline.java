...
/**
 * Interface for document indexing pipeline. Defines the core operations for processing and storing
...
public interface IndexPipeline {
   ...
   */
  List<Document> parse(com.seaskyland.llm.workflow.runtime.domain.knowledgebase.Document document);
