...
public class OssManager implements InitializingBean {
  ...
  List<String> SUPPORT_ENTERPRISE_DATA_MIME_TYPE =
      ImmutableList.of(
          "application/pdf",
          "application/msword",
  ...
  public WebUploadPolicy getWebUploadPolicy(String uid, String type, String fileName) {
    ...
    conditions.addConditionItem(
        PolicyConditions.COND_CONTENT_LENGTH_RANGE, 0, UPLOAD_FILE_SIZE_LIMIT);
  ...
  public String uploadFile(String type, String uid, String path) {
    ...
    try {
      ...
      LogUtils.monitor(
          "ossManager", "uploadFile", start, SUCCESS, path, e.getMessage(), e.getRequestId(), e);
  ...
  private String getObjectName(String uid, String type, String fileName) {
    return new StringBuilder(getObjectPath(uid, type))
