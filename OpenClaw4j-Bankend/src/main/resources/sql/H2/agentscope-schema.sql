...
(
    ...
    KEY idx_workspace_account_id (account_id)
);
...
(
    ...
    KEY idx_plugin_workspace_type (workspace_id, type)
);
...
(
    ...
    KEY idx_agent_workspace_type (workspace_id, type),
    KEY idx_agent_workspace_status (workspace_id, status)
);
