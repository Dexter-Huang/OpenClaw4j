...
(
    id             BIGINT AUTO_INCREMENT NOT NULL COMMENT 'Primary Key ID',
...
(
    id            BIGINT AUTO_INCREMENT NOT NULL COMMENT 'Primary Key ID',
    evaluator_id  BIGINT NOT NULL COMMENT 'Evaluator ID',
    description   TEXT                 DEFAULT NULL COMMENT 'Evaluator description',
    version       VARCHAR(32) NOT NULL COMMENT 'Version number',
...
(
    ...
    tenant_id BIGINT NOT NULL DEFAULT 0,
    PRIMARY KEY (id),
    CONSTRAINT evaluator_template_key_UNIQUE UNIQUE (evaluator_template_key)
);
...
(
    ...
    dataset_id               BIGINT NOT NULL COMMENT 'Dataset ID',
    dataset_version_id       BIGINT NOT NULL COMMENT 'Dataset version ID',
    ...
    complete_time            TIMESTAMP              DEFAULT NULL COMMENT 'Complete time',
    create_time              TIMESTAMP     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Create time',
    update_time              TIMESTAMP     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Update time',
    tenant_id BIGINT NOT NULL DEFAULT 0,
    PRIMARY KEY (id)
...
(
    ...
    evaluation_time      TIMESTAMP          DEFAULT NULL COMMENT 'Evaluation execution time',
    evaluator_version_id BIGINT NOT NULL COMMENT 'Evaluator version ID',
    create_time          TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Create time',
    update_time          TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Update time',
    tenant_id BIGINT NOT NULL DEFAULT 0,
    PRIMARY KEY (id)
...
(
    ...
    create_time    TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    update_time    TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT '更新时间',
    tenant_id BIGINT NOT NULL DEFAULT 0,
    PRIMARY KEY (id),
    CONSTRAINT prompt_key_UNIQUE UNIQUE (prompt_key)
);
...
(
    ...
    tenant_id BIGINT NOT NULL DEFAULT 0,
    PRIMARY KEY (id),
    CONSTRAINT prompt_key_version_UNIQUE UNIQUE (prompt_key,version)
);
...
(
    ...
    tenant_id BIGINT NOT NULL DEFAULT 0,
    PRIMARY KEY (id),
    CONSTRAINT prompt_template_key_UNIQUE UNIQUE (prompt_template_key)
);
